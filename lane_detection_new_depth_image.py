...
class HUD(object):
    ...
    def Lanes_detection(self,img,img_org, nwindows=50, margin=50, minpix = 1, draw_windows=False):
        ...
        try:
                ...
                img_,_ = self.draw_lanes(img, curves[0], curves[1], mid_)
...
##, depth_image
    ...
    def render(self, semantic_image, raw_image, depth_image):
...
class World(object):
    ...
    def render(self, display):
        ...
        if(self.hud is not None):
            self.hud.name = "raw"
            ret, segm = self.hud.render(image_semantic, image, image_depth)
